  ...
  return (
    <CardContainer className="inter-var min-w-[250px] px-0 pt-0">
      <div className="rounded-2xl relative shadow-[0_8px_30px_rgb(0,0,0,0.12)] min-w-[300px] w-auto max-w-[375px] dark:border dark:border-slate-500">
        <div className="group  max-w-[300px] h-[250px] object-contain overflow-hidden rounded-xl my-3 mx-auto">
          <Image
        ...
        <div className="p-5 pt-3 dark:text-white">
          ...
          {project.inProgress && (
            <p className="text-base font-bold">Project is progress</p>
          )}
          ...
          <div className="mt-3">
            <Link target="_blank" href={project.github}>
              <svg
                ...
                y="0px"
                viewBox="0 0 30 30"
                className="fill-slate-700  dark:fill-slate-100 hover:fill-slate-500 dark:hover:fill-slate-500 w-16 h-16"
              >
